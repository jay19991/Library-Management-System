...
USER_TYPE CHAR(2) CONSTRAINT  L_STUDENT_USER_TYPE_CK CHECK(USER_TYPE IN('AD','SM','ST'))
);
...
REGI_DATE DATE DEFAULT SYSDATE,
USER_TYPE CHAR(2) CONSTRAINT  L_STAFF_USER_TYPE_CK CHECK(USER_TYPE IN('AD','SM','ST'))
);
